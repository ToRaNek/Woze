...
/**
 * Classe utilitaire pour valider un ensemble de données
...
public class Verifications{
     ...
     */
    public int getLine(final String[] ligne) {
     ...
     */
    public boolean lineIsValid(final String uneLigne) {
     ...
     */
    public boolean doubleIsValid(final String s) {
     ...
     */
    public boolean transportIsValid(final String transport) {
     ...
     */
    public boolean villeIsValid(final String ville) {
